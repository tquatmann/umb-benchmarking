...
Taken from [QVBS](https://qcomp.org/benchmarks/#embedded) (January 2026).
...
// system status
label "l_down" = (i=2&s<MIN_SENSORS)|(count=MAX_COUNT+1)|(o=2&a<MIN_ACTUATORS)|(m=0); // system has shutdown
...
```
"actuators": P=? [ !"l_down" U "fail_actuators" ];
