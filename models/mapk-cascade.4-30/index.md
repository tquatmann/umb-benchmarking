...
Taken from [QVBS](https://qcomp.org/benchmarks/#mapk-cascade) (January 2026).
...
const int N=4;  // initial amount of MAPK/MAPKK and MAPKKK
...
"activated_time": R{"time"}=? [ F "target" ];
