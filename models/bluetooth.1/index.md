...
Taken from [QVBS](https://qcomp.org/benchmarks/#bluetooth) (January 2026).
...
//----------------------------------------------------------------------------------------------------------------------------
const int mrec = 1; // after receiving mrec messages the inquiry is stopped
...
"time": filter(max, R=? [ F "target" ], "init");
