# Log files for modest_from-umb-xz_check_unsafe on model [csma.4-2](../../models/csma.4-2)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: modest_from-umb-xz_check_unsafe_csma.4-2_rep1.log

```
Command(s):
../bin/modest mcsta models/csma.4-2/modest.model.umb.xz models/csma.4-2/modest.umbxz.properties.txt -I UMB --unsafe -D --exhaustive
Wallclock time: 0.371 seconds
Return code: -6
##############################
The Modest Toolset (www.modestchecker.net), version v3.1.309-gc50f44578+35483c89e7bc88e02bb68bd8068d28d0682448b1.
Command: modest mcsta models/csma.4-2/modest.model.umb.xz models/csma.4-2/modest.umbxz.properties.txt -I UMB --unsafe -D --exhaustive
...
### Log file: modest_from-umb-xz_check_unsafe_csma.4-2_rep2.log
...
### Log file: modest_from-umb-xz_check_unsafe_csma.4-2_rep3.log
...
### Log file: modest_from-umb-xz_check_unsafe_csma.4-2_rep4.log
...
### Log file: modest_from-umb-xz_check_unsafe_csma.4-2_rep5.log
