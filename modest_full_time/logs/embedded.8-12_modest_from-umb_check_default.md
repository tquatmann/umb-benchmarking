...
### Log file: modest_from-umb_check_default_embedded.8-12_rep1.log

```
Command(s):
../bin/modest mcsta models/embedded.8-12/modest.model.umb models/embedded.8-12/modest.umb.properties.txt  -D --exhaustive
Wallclock time: 0.210 seconds
Return code: -6
##############################
The Modest Toolset (www.modestchecker.net), version v3.1.309-gc50f44578+35483c89e7bc88e02bb68bd8068d28d0682448b1.
Command: modest mcsta models/embedded.8-12/modest.model.umb models/embedded.8-12/modest.umb.properties.txt -D --exhaustive
...
### Log file: modest_from-umb_check_default_embedded.8-12_rep2.log

```
Command(s):
../bin/modest mcsta models/embedded.8-12/modest.model.umb models/embedded.8-12/modest.umb.properties.txt  -D --exhaustive
Wallclock time: 0.214 seconds
Return code: -6
##############################
The Modest Toolset (www.modestchecker.net), version v3.1.309-gc50f44578+35483c89e7bc88e02bb68bd8068d28d0682448b1.
Command: modest mcsta models/embedded.8-12/modest.model.umb models/embedded.8-12/modest.umb.properties.txt -D --exhaustive
...
### Log file: modest_from-umb_check_default_embedded.8-12_rep3.log
...
### Log file: modest_from-umb_check_default_embedded.8-12_rep4.log
...
### Log file: modest_from-umb_check_default_embedded.8-12_rep5.log

```
Command(s):
../bin/modest mcsta models/embedded.8-12/modest.model.umb models/embedded.8-12/modest.umb.properties.txt  -D --exhaustive
Wallclock time: 0.349 seconds
Return code: -6
##############################
The Modest Toolset (www.modestchecker.net), version v3.1.309-gc50f44578+35483c89e7bc88e02bb68bd8068d28d0682448b1.
Command: modest mcsta models/embedded.8-12/modest.model.umb models/embedded.8-12/modest.umb.properties.txt -D --exhaustive
