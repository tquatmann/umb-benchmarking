# Log files for modest_from-umb-gz_check_unsafe-memory on model [csma.4-2](../../models/csma.4-2)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: modest_from-umb-gz_check_unsafe-memory_csma.4-2_rep1.log

```
Command(s):
../bin/modest mcsta models/csma.4-2/modest.model.umb.gz models/csma.4-2/modest.umbgz.properties.txt -I UMB --unsafe -S Memory -D --exhaustive
Wallclock time: 0.276 seconds
Return code: -6
##############################
The Modest Toolset (www.modestchecker.net), version v3.1.309-gc50f44578+35483c89e7bc88e02bb68bd8068d28d0682448b1.
Command: modest mcsta models/csma.4-2/modest.model.umb.gz models/csma.4-2/modest.umbgz.properties.txt -I UMB --unsafe -S Memory -D --exhaustive
...
### Log file: modest_from-umb-gz_check_unsafe-memory_csma.4-2_rep2.log
...
### Log file: modest_from-umb-gz_check_unsafe-memory_csma.4-2_rep3.log
...
### Log file: modest_from-umb-gz_check_unsafe-memory_csma.4-2_rep4.log
...
### Log file: modest_from-umb-gz_check_unsafe-memory_csma.4-2_rep5.log
