# Log files for prism_from-prism_check_ex on model [egl.10-2](../../models/egl.10-2)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: prism_from-prism_check_ex_egl.10-2_rep1.log

```
Command(s):
../bin/prism -ex models/egl.10-2/model.prism models/egl.10-2/property.props
Wallclock time: 21.031 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Wed Jan 28 02:57:44 GMT+01:00 2026
Hostname: n23m0181.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism -ex models/egl.10-2/model.prism models/egl.10-2/property.props
...
Computing reachable states... 402728 769900 828884 834269 838218
##############################Output to stderr##############################
...
### Log file: prism_from-prism_check_ex_egl.10-2_rep2.log

```
Command(s):
../bin/prism -ex models/egl.10-2/model.prism models/egl.10-2/property.props
Wallclock time: 22.841 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Wed Jan 28 22:07:36 GMT+01:00 2026
...
Computing reachable states... 362732 705890 820674 834002 836874
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.ArrayList.grow(ArrayList.java:240)
...
### Log file: prism_from-prism_check_ex_egl.10-2_rep3.log

```
Command(s):
../bin/prism -ex models/egl.10-2/model.prism models/egl.10-2/property.props
Wallclock time: 23.800 seconds
Return code: 1
##############################
PRISM
=====
...
Hostname: r23m0149.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism -ex models/egl.10-2/model.prism models/egl.10-2/property.props
...
Computing reachable states... 398332 772884 830363 835643 838128
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.ArrayList.grow(ArrayList.java:240)
...
### Log file: prism_from-prism_check_ex_egl.10-2_rep4.log

```
Command(s):
../bin/prism -ex models/egl.10-2/model.prism models/egl.10-2/property.props
Wallclock time: 25.174 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 339522 651326 805397 831130 834720 837951
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_egl.10-2_rep5.log

```
Command(s):
../bin/prism -ex models/egl.10-2/model.prism models/egl.10-2/property.props
Wallclock time: 20.094 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 385537 745634 827271 834810 837682
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at explicit.DTMCSimple.addStates(DTMCSimple.java:181)
