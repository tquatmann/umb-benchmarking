...
Parsed values: `[0.281, 0.241, 0.193, 0.236, 0.175]`



### Log file: prism_from-prism_check_default_crowds.5-20_rep1.log

```
Command(s):
../bin/prism  models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 5.058 seconds
Return code: 0
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Wed Jan 28 02:45:17 GMT+01:00 2026
...
Prob1: 30 iterations in 0.07 seconds (average 0.002333, setup 0.00)
...
Jacobi: 187 iterations in 3.71 seconds (average 0.018021, setup 0.34)

Value in the initial state: 0.08606841127862043

Time for model checking: 3.878 seconds.
...
### Log file: prism_from-prism_check_default_crowds.5-20_rep2.log

```
Command(s):
../bin/prism  models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 5.461 seconds
Return code: 0
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 00:14:25 GMT+01:00 2026
...
Prob1: 30 iterations in 0.05 seconds (average 0.001667, setup 0.00)
...
Jacobi: 187 iterations in 3.14 seconds (average 0.015027, setup 0.33)

Value in the initial state: 0.08606841127862043

Time for model checking: 3.284 seconds.
...
### Log file: prism_from-prism_check_default_crowds.5-20_rep3.log

```
Command(s):
../bin/prism  models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 8.909 seconds
Return code: 0
##############################
PRISM
=====
...
Jacobi: 187 iterations in 3.32 seconds (average 0.015989, setup 0.33)

Value in the initial state: 0.08606841127862043

Time for model checking: 3.464 seconds.
...
### Log file: prism_from-prism_check_default_crowds.5-20_rep4.log

```
Command(s):
../bin/prism  models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 4.093 seconds
Return code: 0
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 00:23:36 GMT+01:00 2026
...
Jacobi: 187 iterations in 3.20 seconds (average 0.015241, setup 0.35)

Value in the initial state: 0.08606841127862043

Time for model checking: 3.335 seconds.
...
### Log file: prism_from-prism_check_default_crowds.5-20_rep5.log
...
Jacobi: 187 iterations in 3.11 seconds (average 0.014920, setup 0.32)

Value in the initial state: 0.08606841127862043

Time for model checking: 3.234 seconds.
