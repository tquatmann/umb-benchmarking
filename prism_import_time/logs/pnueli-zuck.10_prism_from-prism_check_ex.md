# Log files for prism_from-prism_check_ex on model [pnueli-zuck.10](../../models/pnueli-zuck.10)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: prism_from-prism_check_ex_pnueli-zuck.10_rep1.log

```
Command(s):
../bin/prism -ex models/pnueli-zuck.10/model.prism models/pnueli-zuck.10/property.props
Wallclock time: 17.769 seconds
Return code: 1
##############################
PRISM
=====
...
Command line: prism -ex models/pnueli-zuck.10/model.prism models/pnueli-zuck.10/property.props
...
Computing reachable states... 220093 401008 415403 417305
##############################Output to stderr##############################
...
### Log file: prism_from-prism_check_ex_pnueli-zuck.10_rep2.log
...
Version: 4.9.dev
Date: Wed Jan 28 21:22:17 GMT+01:00 2026
...
Computing reachable states... 204533 384316 413987 416918 417608
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_pnueli-zuck.10_rep3.log
...
Version: 4.9.dev
Date: Wed Jan 28 21:21:40 GMT+01:00 2026
...
Computing reachable states... 237861 407004 415871 417340
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at explicit.ConstructModel.constructModel(ConstructModel.java:287)
...
### Log file: prism_from-prism_check_ex_pnueli-zuck.10_rep4.log

```
Command(s):
../bin/prism -ex models/pnueli-zuck.10/model.prism models/pnueli-zuck.10/property.props
Wallclock time: 16.986 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 242221 403714 415394 417402
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.HashMap.resize(HashMap.java:711)
...
### Log file: prism_from-prism_check_ex_pnueli-zuck.10_rep5.log

```
Command(s):
../bin/prism -ex models/pnueli-zuck.10/model.prism models/pnueli-zuck.10/property.props
Wallclock time: 17.588 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 235372 398853 414239 417277
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
