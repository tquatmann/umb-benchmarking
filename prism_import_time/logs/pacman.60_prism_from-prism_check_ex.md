# Log files for prism_from-prism_check_ex on model [pacman.60](../../models/pacman.60)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: prism_from-prism_check_ex_pacman.60_rep1.log

```
Command(s):
../bin/prism -ex models/pacman.60/model.prism models/pacman.60/property.props
Wallclock time: 53.206 seconds
Return code: 1
##############################
PRISM
=====
...
Command line: prism -ex models/pacman.60/model.prism models/pacman.60/property.props
...
Computing reachable states... 141884 288431 429971 573637 712389 857883 992220 1136551 1280707 1413748 1551362 1649682 1706172 1718411 1724676 1726487
##############################Output to stderr##############################
...
### Log file: prism_from-prism_check_ex_pacman.60_rep2.log

```
Command(s):
../bin/prism -ex models/pacman.60/model.prism models/pacman.60/property.props
Wallclock time: 47.073 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 157540 329629 496573 660726 830239 984426 1150098 1305352 1466244 1598684 1693520 1719259 1725597 1727243
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.ArrayList.grow(ArrayList.java:240)
...
### Log file: prism_from-prism_check_ex_pacman.60_rep3.log

```
Command(s):
../bin/prism -ex models/pacman.60/model.prism models/pacman.60/property.props
Wallclock time: 43.328 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 169733 344477 515671 681304 854432 1020059 1191696 1359905 1523942 1653566 1710356 1722564 1726617
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.ArrayList.grow(ArrayList.java:240)
...
### Log file: prism_from-prism_check_ex_pacman.60_rep4.log

```
Command(s):
../bin/prism -ex models/pacman.60/model.prism models/pacman.60/property.props
Wallclock time: 45.536 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 164925 333609 498339 661436 827621 987782 1155755 1312724 1471444 1594927 1686314 1718352 1725306
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.ArrayList.grow(ArrayList.java:240)
...
### Log file: prism_from-prism_check_ex_pacman.60_rep5.log

```
Command(s):
../bin/prism -ex models/pacman.60/model.prism models/pacman.60/property.props
Wallclock time: 50.939 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 155512 320282 481763 640295 804625 962380 1123136 1284201 1435117 1572095 1675588 1713814 1723704 1726552
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
