# Log files for prism_from-prism_check_ex on model [haddad-monmege.100-0.7](../../models/haddad-monmege.100-0.7)

Parsed values: `[0.087, 0.068, 0.191, 0.026, 0.063]`



### Log file: prism_from-prism_check_ex_haddad-monmege.100-0.7_rep1.log

```
Command(s):
../bin/prism -ex models/haddad-monmege.100-0.7/model.prism models/haddad-monmege.100-0.7/property.props
...
Command line: prism -ex models/haddad-monmege.100-0.7/model.prism models/haddad-monmege.100-0.7/property.props
...
### Log file: prism_from-prism_check_ex_haddad-monmege.100-0.7_rep2.log

```
Command(s):
../bin/prism -ex models/haddad-monmege.100-0.7/model.prism models/haddad-monmege.100-0.7/property.props
Wallclock time: 1.295 seconds
Return code: 0
##############################
PRISM
=====
...
target=1, yes=1, no=1, maybe=199
Starting value iteration (with Jacobi)...
Value iteration (with Jacobi) took 10000 iterations, 3980000 multiplications and 0.034 seconds.
...
### Log file: prism_from-prism_check_ex_haddad-monmege.100-0.7_rep3.log
...
### Log file: prism_from-prism_check_ex_haddad-monmege.100-0.7_rep4.log
...
target=1, yes=1, no=1, maybe=199
Starting value iteration (with Jacobi)...
Value iteration (with Jacobi) took 10000 iterations, 3980000 multiplications and 0.027 seconds.
...
### Log file: prism_from-prism_check_ex_haddad-monmege.100-0.7_rep5.log

```
Command(s):
../bin/prism -ex models/haddad-monmege.100-0.7/model.prism models/haddad-monmege.100-0.7/property.props
Wallclock time: 5.555 seconds
Return code: 0
##############################
PRISM
=====
