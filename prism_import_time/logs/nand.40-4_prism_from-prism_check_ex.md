# Log files for prism_from-prism_check_ex on model [nand.40-4](../../models/nand.40-4)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: prism_from-prism_check_ex_nand.40-4_rep1.log

```
Command(s):
../bin/prism -ex models/nand.40-4/model.prism models/nand.40-4/property.props
Wallclock time: 30.280 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Wed Jan 28 02:56:11 GMT+01:00 2026
Hostname: r23m0077.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism -ex models/nand.40-4/model.prism models/nand.40-4/property.props
...
Computing reachable states... 1911500 2938465 2996198 3012915 3019923 3021881
##############################Output to stderr##############################
...
### Log file: prism_from-prism_check_ex_nand.40-4_rep2.log

```
Command(s):
../bin/prism -ex models/nand.40-4/model.prism models/nand.40-4/property.props
Wallclock time: 25.429 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Wed Jan 28 22:08:11 GMT+01:00 2026
Hostname: n23m0115.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism -ex models/nand.40-4/model.prism models/nand.40-4/property.props
...
Computing reachable states... 2181721 2941012 3003842 3015687 3020533
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
...
### Log file: prism_from-prism_check_ex_nand.40-4_rep3.log
...
Computing reachable states... 2052616 2933254 3001274 3015600 3020471
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_nand.40-4_rep4.log
...
Version: 4.9.dev
Date: Wed Jan 28 20:29:13 GMT+01:00 2026
...
Computing reachable states... 1614170 2818993 2975763 3006283 3013602 3019501 3021633
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.lang.Double.valueOf(Double.java:924)
...
### Log file: prism_from-prism_check_ex_nand.40-4_rep5.log

```
Command(s):
../bin/prism -ex models/nand.40-4/model.prism models/nand.40-4/property.props
Wallclock time: 21.344 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 2172933 2961932 3006351 3014858 3019594
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
