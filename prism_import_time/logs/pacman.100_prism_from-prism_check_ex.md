# Log files for prism_from-prism_check_ex on model [pacman.100](../../models/pacman.100)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: prism_from-prism_check_ex_pacman.100_rep1.log

```
Command(s):
../bin/prism -ex models/pacman.100/model.prism models/pacman.100/property.props
Wallclock time: 45.035 seconds
Return code: 1
##############################
PRISM
=====
...
Command line: prism -ex models/pacman.100/model.prism models/pacman.100/property.props
...
Computing reachable states... 169546 343214 513716 674002 845420 1009165 1181445 1345612 1510726 1644846 1706586 1721364 1725996
##############################Output to stderr##############################
...
### Log file: prism_from-prism_check_ex_pacman.100_rep2.log

```
Command(s):
../bin/prism -ex models/pacman.100/model.prism models/pacman.100/property.props
Wallclock time: 45.990 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 166303 340066 509977 675830 846177 1005366 1177049 1340179 1503835 1637574 1702212 1720443 1725603
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_pacman.100_rep3.log

```
Command(s):
../bin/prism -ex models/pacman.100/model.prism models/pacman.100/property.props
Wallclock time: 45.198 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 00:16:58 GMT+01:00 2026
...
Computing reachable states... 159990 336138 507155 673131 846231 1013261 1189001 1358247 1523847 1645547 1707150 1720782 1725428
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_pacman.100_rep4.log

```
Command(s):
../bin/prism -ex models/pacman.100/model.prism models/pacman.100/property.props
Wallclock time: 46.608 seconds
Return code: 1
##############################
PRISM
=====
...
Hostname: r23m0163.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism -ex models/pacman.100/model.prism models/pacman.100/property.props
...
Computing reachable states... 169574 344634 516802 685105 860294 1028121 1203749 1371227 1537840 1647108 1706745 1720958 1725592
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_pacman.100_rep5.log

```
Command(s):
../bin/prism -ex models/pacman.100/model.prism models/pacman.100/property.props
Wallclock time: 48.474 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 151810 305948 461006 616264 771358 920998 1072034 1227044 1376366 1527530 1644846 1707377 1721585 1726189
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.lang.Integer.valueOf(Integer.java:1019)
