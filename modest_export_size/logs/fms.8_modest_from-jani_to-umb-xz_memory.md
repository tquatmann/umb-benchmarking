# Log files for modest_from-jani_to-umb-xz_memory on model [fms.8](../../models/fms.8)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: modest_from-jani_to-umb-xz_memory_fms.8_rep1.log

```
Command(s):
../bin/modest mcsta models/fms.8/model.jani --umb out/modest_from-jani_to-umb-xz_memory/fms.8/model.umb.xz out/modest_from-jani_to-umb-xz_memory/fms.8/umbxz.properties.txt --umb-compress XZ -S Memory -D --exhaustive
Wallclock time: 0.373 seconds
Return code: -6
##############################
The Modest Toolset (www.modestchecker.net), version v3.1.309-gc50f44578+35483c89e7bc88e02bb68bd8068d28d0682448b1.
Command: modest mcsta models/fms.8/model.jani --umb out/modest_from-jani_to-umb-xz_memory/fms.8/model.umb.xz out/modest_from-jani_to-umb-xz_memory/fms.8/umbxz.properties.txt --umb-compress XZ -S Memory -D --exhaustive
...
############################## Output files ##############################
out/modest_from-jani_to-umb-xz_memory/fms.8/model.umb.xz:	File does not exist.
out/modest_from-jani_to-umb-xz_memory/fms.8/umbxz.properties.txt:	File does not exist.
```
