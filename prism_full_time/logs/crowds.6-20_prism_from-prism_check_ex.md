# Log files for prism_from-prism_check_ex on model [crowds.6-20](../../models/crowds.6-20)

Parsed values: `[ERR, ERR, ERR, ERR, ERR]`



### Log file: prism_from-prism_check_ex_crowds.6-20_rep1.log

```
Command(s):
../bin/prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 59.702 seconds
Return code: 1
##############################
PRISM
=====
...
Command line: prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
...
Computing reachable states... 424544 770869 1279375 1595052 1706295 1737217 1755549 1766043 1772455 1776267 1778671 1780807 1781992 1782945 1783896 1784844
##############################Output to stderr##############################
...
### Log file: prism_from-prism_check_ex_crowds.6-20_rep2.log

```
Command(s):
../bin/prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 49.394 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 01:00:58 GMT+01:00 2026
Hostname: n23m0143.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
...
Computing reachable states... 465644 831443 1401303 1613779 1713575 1743257 1761353 1770898 1775648 1778777 1781154 1782337 1783522 1784713
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_crowds.6-20_rep3.log

```
Command(s):
../bin/prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 43.395 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Wed Jan 28 20:38:11 GMT+01:00 2026
...
Computing reachable states... 551533 985369 1523335 1700776 1739820 1760526 1771262 1776258 1779611 1781982 1783403 1784832
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at parser.State.<init>(State.java:50)
...
### Log file: prism_from-prism_check_ex_crowds.6-20_rep4.log

```
Command(s):
../bin/prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 47.950 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 513442 915398 1469323 1681190 1726276 1752721 1766061 1772952 1777248 1779640 1781540 1782728 1783914
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
### Log file: prism_from-prism_check_ex_crowds.6-20_rep5.log

```
Command(s):
../bin/prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 44.092 seconds
Return code: 1
##############################
PRISM
=====
...
Hostname: r23m0166.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism -ex models/crowds.6-20/model.prism models/crowds.6-20/property.props
...
Computing reachable states... 559563 963449 1523058 1694877 1738145 1759091 1769827 1775045 1778648 1781326 1782450 1783636 1784964
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at parser.State.<init>(State.java:50)
