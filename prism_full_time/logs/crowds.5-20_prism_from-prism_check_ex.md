...
### Log file: prism_from-prism_check_ex_crowds.5-20_rep1.log

```
Command(s):
../bin/prism -ex models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 30.183 seconds
Return code: 1
##############################
PRISM
=====
...
Command line: prism -ex models/crowds.5-20/model.prism models/crowds.5-20/property.props
...
Computing reachable states... 519606 909255 1445406 1679136 1799670 1845277 1851358
##############################Output to stderr##############################
...
### Log file: prism_from-prism_check_ex_crowds.5-20_rep2.log

```
Command(s):
../bin/prism -ex models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 28.910 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 03:05:05 GMT+01:00 2026
...
Computing reachable states... 553198 947029 1471535 1701097 1818202 1848607 1852661
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space: failed reallocation of scalar replaced objects
	at java.base/java.lang.Double.valueOf(Double.java:924)
...
### Log file: prism_from-prism_check_ex_crowds.5-20_rep3.log

```
Command(s):
../bin/prism -ex models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 24.104 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 585843 1024246 1520185 1723912 1834095 1850311
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
...
### Log file: prism_from-prism_check_ex_crowds.5-20_rep4.log

```
Command(s):
../bin/prism -ex models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 30.513 seconds
Return code: 1
##############################
PRISM
=====
...
Computing reachable states... 457013 800400 1338813 1606455 1732244 1830553 1848796 1852850
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.ArrayList.grow(ArrayList.java:240)
...
### Log file: prism_from-prism_check_ex_crowds.5-20_rep5.log

```
Command(s):
../bin/prism -ex models/crowds.5-20/model.prism models/crowds.5-20/property.props
Wallclock time: 27.263 seconds
Return code: 1
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 00:27:13 GMT+01:00 2026
...
Computing reachable states... 514724 924270 1475961 1716292 1817618 1847010 1853091
##############################Output to stderr##############################
Picked up JAVA_TOOL_OPTIONS: -Xmx32g
Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
	at java.base/java.util.ArrayList.grow(ArrayList.java:240)
