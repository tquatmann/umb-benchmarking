# Log files for prism_from-prism_check_norewards on model [crowds.6-20](../../models/crowds.6-20)

Parsed values: `[15.089, 16.674, 16.17, 21.141, 17.446]`



### Log file: prism_from-prism_check_norewards_crowds.6-20_rep1.log

```
Command(s):
../bin/prism  models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 15.089 seconds
Return code: 0
##############################
PRISM
=====
...
Starting iterations...
Iteration 82: max relative diff=0.009107, 5.04 sec so far
Iteration 165: max relative diff=0.000030, 10.10 sec so far

Jacobi: 206 iterations in 13.90 seconds (average 0.061117, setup 1.31)

Value in the initial state: 0.12047517459031545

Time for model checking: 14.099 seconds.
...
### Log file: prism_from-prism_check_norewards_crowds.6-20_rep2.log

```
Command(s):
../bin/prism  models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 16.674 seconds
Return code: 0
##############################
PRISM
=====
...
Hostname: n23m0217.hpc.itc.rwth-aachen.de
Memory limits: cudd=1g, java(heap)=1g
Command line: prism models/crowds.6-20/model.prism models/crowds.6-20/property.props
...
Starting iterations...
Iteration 76: max relative diff=0.012497, 5.07 sec so far
Iteration 152: max relative diff=0.000076, 10.10 sec so far

Jacobi: 206 iterations in 15.07 seconds (average 0.066456, setup 1.38)

Value in the initial state: 0.12047517459031545

Time for model checking: 15.282 seconds.
...
### Log file: prism_from-prism_check_norewards_crowds.6-20_rep3.log

```
Command(s):
../bin/prism  models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 16.170 seconds
Return code: 0
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 02:54:49 GMT+01:00 2026
...
Prob1: 37 iterations in 0.11 seconds (average 0.002973, setup 0.00)
...
Starting iterations...
Iteration 75: max relative diff=0.013178, 5.05 sec so far
Iteration 150: max relative diff=0.000095, 10.11 sec so far

Jacobi: 206 iterations in 14.96 seconds (average 0.066214, setup 1.32)

Value in the initial state: 0.12047517459031545

Time for model checking: 15.196 seconds.
...
### Log file: prism_from-prism_check_norewards_crowds.6-20_rep4.log

```
Command(s):
../bin/prism  models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 21.141 seconds
Return code: 0
##############################
PRISM
=====
...
Version: 4.9.dev
Date: Thu Jan 29 00:56:53 GMT+01:00 2026
...
Reachability (BFS): 56 iterations in 0.29 seconds (average 0.005179, setup 0.00)

Time for model construction: 0.507 seconds.
...
Prob0: 14 iterations in 0.07 seconds (average 0.005000, setup 0.00)

Prob1: 37 iterations in 0.15 seconds (average 0.004054, setup 0.00)
...
Starting iterations...
Iteration 60: max relative diff=0.026504, 5.09 sec so far
Iteration 119: max relative diff=0.000855, 10.10 sec so far
Iteration 176: max relative diff=0.000011, 15.15 sec so far

Jacobi: 206 iterations in 19.53 seconds (average 0.086893, setup 1.63)

Value in the initial state: 0.12047517459031545

Time for model checking: 19.89 seconds.
...
### Log file: prism_from-prism_check_norewards_crowds.6-20_rep5.log

```
Command(s):
../bin/prism  models/crowds.6-20/model.prism models/crowds.6-20/property.props
Wallclock time: 17.446 seconds
Return code: 0
##############################
PRISM
=====
...
Starting iterations...
Iteration 79: max relative diff=0.010682, 5.07 sec so far
Iteration 157: max relative diff=0.000060, 10.14 sec so far

Jacobi: 206 iterations in 14.72 seconds (average 0.065049, setup 1.32)

Value in the initial state: 0.12047517459031545

Time for model checking: 14.918 seconds.
