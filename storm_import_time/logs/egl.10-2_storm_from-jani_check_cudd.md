# Log files for storm_from-jani_check_cudd on model [egl.10-2](../../models/egl.10-2)

Parsed values: `[317.79999999999995, 353.692, 316.545, 358.786, 316.981]`



### Log file: storm_from-jani_check_cudd_egl.10-2_rep1.log

```
Command(s):
../bin/storm --timemem --buildfull --jani models/egl.10-2/model.jani --janiproperty  --engine dd-to-sparse --ddlib cudd --cudd:maxmem 8192
Wallclock time: 321.054 seconds
Return code: 0
##############################
Storm 1.11.1 (dev)

Date: Wed Jan 28 02:23:59 2026
Command line arguments: --timemem --buildfull --jani models/egl.10-2/model.jani --janiproperty --engine dd-to-sparse --ddlib cudd '--cudd:maxmem' 8192
...
Time for model preprocessing: 317.518s.
...
Time for model checking: 3.191s.

Performance statistics:
  * peak memory usage: 4676MB
  * CPU time: 319.486s
  * wallclock time: 321.008s
```



### Log file: storm_from-jani_check_cudd_egl.10-2_rep2.log

```
Command(s):
../bin/storm --timemem --buildfull --jani models/egl.10-2/model.jani --janiproperty  --engine dd-to-sparse --ddlib cudd --cudd:maxmem 8192
Wallclock time: 358.790 seconds
Return code: 0
##############################
Storm 1.11.1 (dev)

Date: Wed Jan 28 20:29:06 2026
Command line arguments: --timemem --buildfull --jani models/egl.10-2/model.jani --janiproperty --engine dd-to-sparse --ddlib cudd '--cudd:maxmem' 8192
Current working directory: /rwthfs/rz/cluster/hpcwork/rwth1632/umb-benchmarking/experiments-final
...
Time for model preprocessing: 353.259s.
...
Performance statistics:
  * peak memory usage: 4676MB
  * CPU time: 354.935s
  * wallclock time: 357.486s
```



### Log file: storm_from-jani_check_cudd_egl.10-2_rep3.log

```
Command(s):
../bin/storm --timemem --buildfull --jani models/egl.10-2/model.jani --janiproperty  --engine dd-to-sparse --ddlib cudd --cudd:maxmem 8192
Wallclock time: 319.809 seconds
Return code: 0
##############################
Storm 1.11.1 (dev)
...
Time for model preprocessing: 316.165s.
...
Model checking property "unfairA": Pmin=? [F ((!"knowA") & "knowB")] ...
Result (for initial states): 0.5004882812
Time for model checking: 3.205s.

Performance statistics:
  * peak memory usage: 4676MB
  * CPU time: 318.279s
  * wallclock time: 319.766s
```



### Log file: storm_from-jani_check_cudd_egl.10-2_rep4.log

```
Command(s):
../bin/storm --timemem --buildfull --jani models/egl.10-2/model.jani --janiproperty  --engine dd-to-sparse --ddlib cudd --cudd:maxmem 8192
Wallclock time: 362.397 seconds
Return code: 0
##############################
Storm 1.11.1 (dev)
...
Time for model preprocessing: 358.457s.
...
Model checking property "unfairA": Pmin=? [F ((!"knowA") & "knowB")] ...
Result (for initial states): 0.5004882812
Time for model checking: 3.547s.

Performance statistics:
  * peak memory usage: 4677MB
  * CPU time: 360.577s
  * wallclock time: 362.351s
```



### Log file: storm_from-jani_check_cudd_egl.10-2_rep5.log

```
Command(s):
../bin/storm --timemem --buildfull --jani models/egl.10-2/model.jani --janiproperty  --engine dd-to-sparse --ddlib cudd --cudd:maxmem 8192
Wallclock time: 320.282 seconds
Return code: 0
##############################
Storm 1.11.1 (dev)
...
WARN  (DdJaniModelBuilder.cpp:1507): The guard '((phase = 3) & (n = 16))' is unsatisfiable.
WARN  (DdJaniModelBuilder.cpp:1507): The guard '((phase = 3) & (n = 18))' is unsatisfiable.
Time for model construction: 0.249s.
...
Time for model preprocessing: 316.727s.
...
Model checking property "unfairA": Pmin=? [F ((!"knowA") & "knowB")] ...
Result (for initial states): 0.5004882812
Time for model checking: 3.244s.

Performance statistics:
  * peak memory usage: 4677MB
  * CPU time: 318.772s
  * wallclock time: 320.241s
```
