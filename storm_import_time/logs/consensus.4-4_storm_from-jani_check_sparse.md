...
Parsed values: `[0.162, 0.159, 0.22399999999999998, 0.185, 0.137]`



### Log file: storm_from-jani_check_sparse_consensus.4-4_rep1.log

```
Command(s):
../bin/storm --timemem --buildfull --jani models/consensus.4-4/model.jani --janiproperty
...
Command line arguments: --timemem --buildfull --jani models/consensus.4-4/model.jani --janiproperty
...
Performance statistics:
  ...
  * CPU time: 0.434s
  * wallclock time: 0.451s
```



### Log file: storm_from-jani_check_sparse_consensus.4-4_rep2.log
...
### Log file: storm_from-jani_check_sparse_consensus.4-4_rep3.log
...
Model checking property "disagree": Pmax=? [F ("finished" & (!"agree"))] ...
Result (for initial states): 0.1560478083
Time for model checking: 0.362s.

Performance statistics:
  * peak memory usage: 62MB
  * CPU time: 0.547s
  * wallclock time: 0.589s
```



### Log file: storm_from-jani_check_sparse_consensus.4-4_rep4.log
...
### Log file: storm_from-jani_check_sparse_consensus.4-4_rep5.log
